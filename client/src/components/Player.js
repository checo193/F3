    ...
    >
      ...
      <div className="Player_playerStats">
        <div className="Player_playerStats1">
          <h5 className={determineStatClass(player)}>Games: {player.games}</h5>
          <h5 className={determineStatClass(player)}>Wins: {player.wins}</h5>
          <h5 className={determineStatClass(player)}>
            Losses: {player.losses}
          </h5>
        </div>
        <div className="Player_playerStats2">
          <h5 className={determineStatClass(player)}>Motms: {player.motms}</h5>
          <h5 className={determineStatClass(player)}>Goals: {player.goals}</h5>
          <h5 className={determineStatClass(player)}>
