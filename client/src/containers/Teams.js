...
export default function Teams({ squad, updatePlayerStats, updateGameStats, updatePlayerWins }) {
  ...
  */
  ...
  return (
    <>
      ...
      <div>
        <GameForm team1={team1} team2={team2} updateGameStats={updateGameStats} updatePlayerWins={updatePlayerWins}/>
      </div>
    </>
  );
}
